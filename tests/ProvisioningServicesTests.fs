...
type private FakeProcSupervisorClient(startFactory: string * ProcHostSpec -> ProcHostSnapshot) =
    ...
    task {
        ...
        let procClient =
            FakeProcSupervisorClient(fun _ ->
                failwith "StartProc should not be called for InProcHost")
